...
let literal_tests =
  List.map
    ...
    [ ("\x00", "i8.dec  0");
      ...
      ("\x01\x00\x00\x00\x00\x00\x00\x00", "i64.le.dec  1");
      ("\x00", "i8.hex 0");
      ("\x01", "i8.hex 1");
      ("\xff", "i8.hex ff");
      ("\x00\x00", "i16.hex 0");
      ...
      ("\x01\x00\x00\x00\x00\x00\x00\x00", "i64.le.hex  1");
      ("", {|utf8 ""|});
      ("abc", {|utf8 "abc"|});
